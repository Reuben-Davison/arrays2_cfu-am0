...
weather_options.each do |weather_option|
  puts "Good Morning, today will be #{weather_option}."
end
...
# Record yourself live-coding and talking through either Challenge 1 or 2. The recording doesn't have to be the first time you are solving the problem. Use technical vocabulary and explain each part to demonstrate your understanding!
